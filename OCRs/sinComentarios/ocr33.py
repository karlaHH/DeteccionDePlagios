...
def recolectar(rutas):
    ...
    for i in range(len(rutas)):
        ...
        col, filas = img1.size
        lineas.append(i+1)
        lineas.append(filascolumnas(filas,col))
        lineas.append(unostamanio(img,filas,col))
        
        r_col = cortecolum(img, filas, col)
        
        r_filas = cortesfilas(img, filas, col)
        lineas.append(r_col[0])
        lineas.append(r_col[1])
        lineas.append(r_col[2])
        lineas.append(r_filas[0])
        lineas.append(r_filas[1])
        lineas.append(r_filas[2])
        lineas.append(r_col[3])
        lineas.append(r_col[4])
        lineas.append(r_col[5])
        lineas.append(r_filas[3])
        lineas.append(r_filas[4])
        lineas.append(r_filas[5])
        
        
        
        lineas.append (str(rutas[i][12]))
...
def dataset(r_imagen):
    ...
    col, filas = img1.size
    datos.append(filascolumnas(filas,col))
    datos.append(unostamanio(img,filas,col))
    
    r_col = cortecolum(img, filas, col)
    
    r_filas = cortesfilas(img, filas, col)
    datos.append(r_col[0])
    datos.append(r_col[1])
    datos.append(r_col[2])
    datos.append(r_filas[0])
    datos.append(r_filas[1])
    datos.append(r_filas[2])
    datos.append(r_col[3])
    datos.append(r_col[4])
    datos.append(r_col[5])
    datos.append(r_filas[3])
    datos.append(r_filas[4])
    datos.append(r_filas[5])
    return datos
