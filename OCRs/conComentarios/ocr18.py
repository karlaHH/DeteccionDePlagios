...
if __name__ == "__main__":                                              #Aqui indicamos la funcion main
    ...
    while True:                                                         #Hacemos un while que se repita hasta que el usuario lo detenga
        print('\n___________Bienvenido usuario______________')            #Imprimimos el menu principal
        print('|                                         |')            #Imprimimos el menu principal        
        print('|    1.-Generar el archivo CSV (DataSet)  |')            #Imprimimos el menu principal
        print('|    2.-Buscar un número por KNN          |')            #Imprimimos el menu principal
        print('|    3.-Salir del programa                |')            #Imprimimos el menu principal
        print('|_________________________________________|')            #Imprimimos el menu principal
        ...
        if opcion==1:                                                   #Validamos si seleccionamos la opcion 1
            ...
            for va in range(numVeci):                                  #For para imprimir los K vecinos
                print("Num. vecino: ",va+1,"\n Posición en DataSet: ", mat[va][0]+1,"\n Clase: ",mat[va][2],"\n Distancia: ",mat[va][1]+0.3431100858184699)  #Se imprimen solamente los vecinos más cercanos indicados anteriormente
